...
public class OpenAccWithIqama {
	...
	public void test() {
		...
		testdata = TestDataManager.readCsv("IqamaID");
		...
		try {
			while (testdata.readRecord()) {
				...
				OpenAccountPageObj.selectCustomerClassification("Expatriates");
				...
				OpenAccountPageObj.selectIDType("Iqama");
				...
				// CustomerInformationPageObj.enterMobileNumber(testdata);
				CustomerInformationPageObj.clickMailingAddressSameAsNationalAddress();
				CustomerInformationPageObj.selectHomeCountry();
				CustomerInformationPageObj.enterHomeCity();
				CustomerInformationPageObj.enterHomeStreetAddress();
				CustomerInformationPageObj.enterHomeMobileNumber();
				...
				CustomerInformationPageObj.enterPositionInIqama();
